...
export default function Services() {
  return (
    <>
      <SEOHead 
        title="Our Services — Property, Construction, Vehicles | SKY A Groups"
        description="Explore the multi-service excellence of SKY A Groups in Tamil Nadu. We offer property development, civil works, vehicle sales, uniforms, events, and web design."
      />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-3xl mb-16">
            ...
            <p className="font-body text-grey-text text-lg leading-relaxed">
              SKY A Groups was founded with a singular vision: to be the most reliable, diversified service provider in Tamil Nadu. We have meticulously curated our offerings to ensure that whether you are building a home, scaling a business, or hosting a monumental event, you have a trusted partner by your side.
            </p>
          </div>
