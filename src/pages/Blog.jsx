...
export default function Blog() {
  ...
  return (
    <>
      <SEOHead 
        title="Blog — Property, Construction & Business Tips | SKY A Groups"
        description="Expert insights from SKY A Groups on property, civil construction, event planning, vehicle sales, and web design in Tamil Nadu."
      />
          ...
          <div className="flex flex-wrap gap-3 mb-12 justify-center md:justify-start">
            {categories.map((cat) => (
              <button
                ...
                className={`font-label text-xs uppercase tracking-widest px-6 py-2 rounded-full transition-colors ${
                  activeCategory === cat 
