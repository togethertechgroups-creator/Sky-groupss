...
export default function WebDesign() {
  return (
    <>
      ...
      introParagraphs={[
        "In the modern era, your website is your digital storefront. SKY A Groups designs and develops premium, lightning-fast, and deeply engaging websites that convert visitors into loyal customers.",
