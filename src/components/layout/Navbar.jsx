...
export default function Navbar() {
  ...
  return (
    <nav 
      className={`fixed top-0 w-full z-50 transition-all duration-300 bg-white shadow-md border-b-2 border-gold/20 ${
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center space-x-8">
            <Link 
              to="/" 
              className={`font-label uppercase text-sm tracking-wider hover:text-gold transition-colors ${
            ...
            <Link 
              to="/about" 
              className={`font-label uppercase text-sm tracking-wider hover:text-gold transition-colors ${
                isActive('/about') ? 'text-gold' : 'text-charcoal'
              }`}
            >
              About
            </Link>
            ...
            >
              <div className={`flex items-center gap-1 font-label uppercase text-sm tracking-wider hover:text-gold transition-colors py-2 ${
                isServiceActive ? 'text-gold' : 'text-charcoal'
              }`}>
            ...
            <Link 
              to="/blog" 
              className={`font-label uppercase text-sm tracking-wider hover:text-gold transition-colors ${
                isActive('/blog') ? 'text-gold' : 'text-charcoal'
              }`}
            >
              Blog
            </Link>
            ...
            <Link 
              to="/contact" 
              className={`font-label uppercase text-sm tracking-wider hover:text-gold transition-colors ${
                isActive('/contact') ? 'text-gold' : 'text-charcoal'
              }`}
            >
              Contact
            </Link>
